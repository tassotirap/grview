...
public abstract class AbstractInputHandler<E extends AbstractEditAction>
{
	 ...
	 * @param from the source, it can be {@link org.grview.actions.View#VIEW},
	 * {@link org.grview.actions.View#ACTION_BAR} or {@link org.grview.actions.View#TEXT_AREA}
	 ...
	 * This is the entry point of the mouse handling
	 * 
	 * @param evt the mouse event
	 * @param from the source, it can be (@link org.grview.actions.View#View),
	 * (@ling asin.util.action.View#ACTION_BAR) or (@link org.grview.actions.View#TEXT_AREA)
	 * @param global tell if the event comes from the DefaultKeyboardFocusManager or not
	 */
