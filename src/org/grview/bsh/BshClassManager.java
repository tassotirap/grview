...
public class BshClassManager
{
    ...
    */
    ...
    /**
        ...
        @see org.grview.bsh.Interpreter#getClassManager() getClassManager
        @see org.grview.bsh.Interpreter#setClassLoader(ClassLoader) setClassLoader
    */
    public static BshClassManager createClassManager( Interpreter interpreter )
    {
        ...
        if ( Capabilities.classExists("java.lang.ref.WeakReference")
            ...
            && Capabilities.classExists("org.grview.bsh.classpath.ClassManagerImpl")
        )
            try {
                // Try to load the module
                // don't refer to it directly here or we're dependent upon it
                Class clas = Class.forName( "org.grview.bsh.classpath.ClassManagerImpl" );
