...
package org.grview.bsh.collection;

import java.util.Iterator;
import java.util.Collection;
import java.util.Map;

import org.grview.bsh.BshIterator;
...
/**
	Dynamically loaded extension supporting post 1.1 collections iterator.
 	@author Pat Niemeyer
 */
public class CollectionManagerImpl extends org.grview.bsh.CollectionManager
{
	@Override
		...
		throws IllegalArgumentException
	{
		if ( obj instanceof Collection || obj instanceof Iterator )
			...
			return new org.grview.bsh.CollectionManager.BasicBshIterator( obj );
	}
