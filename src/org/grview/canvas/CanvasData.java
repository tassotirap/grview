...
public class CanvasData
{
	...
	public final static String CURSOS_LABEL_ENABLED = ORG_GRVIEW_IMAGES + "cursor_label_enabled.png";
	public final static String CURSOS_LAMBDA_ENABLED = ORG_GRVIEW_IMAGES + "cursor_l_enabled.png";
	public final static String CURSOS_LEFT_SIDE_ENABLED = ORG_GRVIEW_IMAGES + "cursor_h_enabled.png";
	public final static String CURSOS_N_TERMINAL_ENABLED = ORG_GRVIEW_IMAGES + "cursor_nt_enabled.png";
	public final static String CURSOS_START_ENABLED = ORG_GRVIEW_IMAGES + "cursor_s_enabled.png";
	public final static String CURSOS_SUCCESSOR_ENABLED = ORG_GRVIEW_IMAGES + "cursor_successor_enabled.gif";
	public final static String CURSOS_TERMINAL_ENABLED = ORG_GRVIEW_IMAGES + "cursor_t_enabled.png";
