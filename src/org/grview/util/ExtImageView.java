...
public class ExtImageView extends View implements ImageObserver, MouseListener, MouseMotionListener
{
	 ...
	 */
	public ExtImageView(Element elem, String ApplicationImagePath)
	{
		super(elem);
	...
	float getVerticalAlignment()
	{
		...
		if (align != null)
		{
			...
			if (align.equals(TOP) || align.equals(TEXTTOP))
				return 0.0f;
			else if (align.equals(ExtImageView.CENTER) || align.equals(MIDDLE) || align.equals(ABSMIDDLE))
				return 0.5f;
		}
	...
	private Icon makeIcon(final String gifFile) throws IOException
	{
		 ...
		 */
		InputStream resource = ExtImageView.class.getResourceAsStream(gifFile);

		if (resource == null)
		{
			System.err.println(ExtImageView.class.getName() + "/" + gifFile + " not found.");
			return null;
		}
