...
public class StandardUtilities
{
	 ...
	 * @param str
	 *            A java string
	 * @return the leading whitespace of that string, for indenting subsequent
	 *         lines.
	...
	/**
	 * Returns the array offset of a virtual column number (taking tabs into
	 * account) in the segment.
	 * 
	 * @param seg
	 *            The segment
	 * @param tabSize
	 ...
	 * 
	 * @param seq
	 *            The test CharSequence.
	 * @param toff
	 *            Offset for the test sequence.
	 * @param other
	 *            The sequence to compare to.
	 * @param ooff
	 *            Offset of the comparison sequence.
	 * @param len
