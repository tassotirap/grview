...
public class XMLUtilities
{
	...
	public static boolean parseXML(InputStream in, DefaultHandler handler) throws IOException
	{
		...
		catch (SAXParseException se)
		{
			...
			Log.log(Log.ERROR, XMLUtilities.class, "Error while parsing from " + in + ": SAXParseException: line " + line + ": ", se);
			return true;
		}
		catch (SAXException e)
		{
			Log.log(Log.ERROR, XMLUtilities.class, "Error while parsing from " + in, e);
			return true;
		}
		finally
		{
			...
			{
				Log.log(Log.ERROR, XMLUtilities.class, "Error while parsing from " + in, io);
			}
		}
		return false;
	} // }}}
