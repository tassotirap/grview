...
import org.grview.editor.indent.IndentAction;
import org.grview.editor.indent.IndentRule;
import org.grview.editor.syntax.DefaultTokenHandler;
import org.grview.editor.syntax.DummyTokenHandler;
import org.grview.editor.syntax.KeywordMap;
...
import org.grview.util.IntegerArray;
...
/**
 * A <code>JEditBuffer</code> represents the contents of an open text file as it
 * is maintained in the computer's memory (as opposed to how it may be stored on
 * a disk).
 * <p>
 * 
 ...
 * <li>When accessing the buffer from another thread, you must grab a read lock
 * if you plan on performing more than one call, to ensure that the buffer
 * contents are not changed by the AWT thread for the duration of the lock. Only
 * methods whose descriptions specify thread safety can be invoked from other
 * threads.
 * </ul>
 * 
 * @author Slava Pestov
...
public class JEditBuffer
{
	 ...
	 *            The listener
	 * @param priority
	 *            Listeners with HIGH_PRIORITY get the event before listeners
	 *            with NORMAL_PRIORITY
	 * @since jEdit 4.3pre3
	 */
	 ...
	 * {@link #endCompoundEdit()} are called will be merged into one. This can
	 * be used to make a complex operation undoable in one step. Nested calls to
	 * {@link #beginCompoundEdit()} behave as expected, requiring the same
	 * number of {@link #endCompoundEdit()} calls to end the edit.
	 * 
	 * @see #endCompoundEdit()
	 */
	 ...
	 * {@link #beginCompoundEdit()} was called can now be undone in one step by
	 * calling {@link #undo(TextArea)}.
	 * 
	...
	/**
	 * Some settings, like comment start and end strings, can vary between
	 * different parts of a buffer (HTML text and inline JavaScript, for
	 * example).
	 * 
	 * @param offset
	 *            The offset
	 ...
	 *            If this is non-null, the number of whitespace characters is
	 *            stored at the 0 index
	 * @since jEdit 4.2pre2
	 */
	 ...
	 * is the end line, of the fold containing the specified line number.
	 * 
	 * @param line
	 *            The line number
	 * @since jEdit 4.0pre3
	...
	/**
	 * Returns the ideal leading indent for the specified line. This will apply
	 * the various auto-indent rules.
	 * 
	 * @param lineIndex
	 *            The line number
	 */
	...
	/**
	 * Returns the indent size used in this buffer. This is equivalent to
	 * calling <code>getProperty("indentSize")</code>. This method is
	 * thread-safe.
	 * 
	 * @since jEdit 2.7pre1
	 */
	...
	/**
	 * Returns the syntax highlighting keyword map in effect at the specified
	 * offset. Used by the <b>Complete Word</b> command to complete keywords.
	 * 
	 * @param offset
	 *            The offset
	 * @since jEdit 4.0pre3
	...
	// {{{ getLength() method
	/**
	 * Returns the number of characters in the buffer. This method is
	 * thread-safe.
	 */
	...
	// {{{ getLineCount() method
	/**
	 * Returns the number of physical lines in the buffer. This method is
	 * thread-safe.
	 * 
	 * @since jEdit 3.1pre1
	 */
	 ...
	 * @param line
	 *            The line
	 * @return The end offset of the specified line invalid.
	 * @since jEdit 4.0pre1
	 */
	...
	/**
	 * Returns the line containing the specified offset. This method is
	 * thread-safe.
	 * 
	 * @param offset
	 *            The offset
	...
	/**
	 * Returns the start offset of the specified line. This method is
	 * thread-safe.
	 * 
	 * @param line
	 *            The line
	...
	/**
	 * Returns the offset of a virtual column number (taking tabs into account)
	 * relative to the start of the line in question.
	 * 
	 * @param line
	 *            The line number
	 * @param column
	 *            The virtual column number
	 * @param totalVirtualWidth
	 *            If this array is non-null, the total virtual width will be
	 *            stored in its first location if this method returns -1.
	 * 
	...
	// {{{ getPatternProperty()
	/**
	 * Returns the value of a property as a regular expression. This method is
	 * thread-safe.
	 * 
	 * @param name
	 *            The property name
	 ...
	 * <code>Object</code> which must be cast to another type in order to be
	 * useful, and this can cause problems if the object is of a different type
	 ...
	 * 
	 * @param name
	 *            The property name. For backwards compatibility, this is an
	 *            <code>Object</code>, not a <code>String</code>.
	 */
	...
	// {{{ getTabSize() method
	/**
	 * Returns the tab size used in this buffer. This is equivalent to calling
	 * <code>getProperty("tabSize")</code>. This method is thread-safe.
	 */
	 ...
	 * 
	 * @param lineIndex
	 *            The line number to indent
	 * @param canDecreaseIndent
	 *            If true, the indent can be decreased as a result of this. Set
	 *            this to false for Tab key.
	 ...
	 * 
	 * @param start
	 *            The first line to indent
	 * @param end
	 *            The last line to indent
	 * @since jEdit 3.1pre3
	 */
	 ...
	 * the specified virtual column. Inserts spaces as appropriate if the line
	...
	/**
	 * Inserts a string into the buffer, indenting each line of the string to
	 * match the indent of the first line.
	 * 
	 * @param offset
	 *            The offset
	 * @param text
	 *            The text
	 * 
	 * @return The number of characters of indent inserted on each new line.
	 *         This is used by the abbreviations code.
	 * 
	...
	// {{{ isDirty() method
	/**
	 * Returns whether there have been unsaved changes to this buffer. This
	...
	// {{{ isEditable() method
	/**
	 * Returns true if this file is editable, false otherwise. A file may become
	 * uneditable if it is read only, or if I/O is in progress. This method is
	 * thread-safe.
	 * 
	 * @since jEdit 2.7pre1
	 */
	...
	/**
	 * Returns true if the buffer is currently performing I/O. This method is
	 * thread-safe.
	 * 
	 * @since jEdit 2.7pre1
	 */
	...
	// {{{ isReadOnly() method
	/**
	 * Returns true if this file is read only, false otherwise. This method is
	 * thread-safe.
	 */
	 ...
	 * {@link org.grview.actions.buffer.BufferListener#transactionComplete(JEditBuffer)}
	...
	/**
	 * Reloads settings from the properties. This should be called after the
	 * <code>syntax</code> or <code>folding</code> buffer-local properties are
	 * changed.
	 */
	...
	/**
	 * Sets this buffer's edit mode. Note that calling this before a buffer is
	 * loaded will have no effect; in that case, set the "mode" property to the
	 * name of the mode. A bit inelegant, I know...
	 * 
	 * @param mode
	 *            The mode
	 */
	...
	{
		/*
		 * This protects against stupid people (like me) doing stuff like
		 * buffer.setMode(jEdit.getMode(...));
		 */
		if (mode == null)
