...
public interface IndentRule
{
	 ...
	 *            the line index
	 * @param prevLineIndex
	 *            the prior non empty line index (or -1 if there is no prior non
	 *            empty line)
	 * @param prevPrevLineIndex
	 *            the prior non empty line index before the prevLineIndex (or -1
	 *            if there is no prior non empty line)
	 * @param indentActions
