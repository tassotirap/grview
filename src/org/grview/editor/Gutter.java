...
/**
 * The gutter is the component that displays folding triangles and line numbers
 * to the left of the text area. The only methods in this class that should be
 * called by plugins are those for adding and removing text area extensions.
 * 
...
public class Gutter extends JComponent implements SwingConstants
{
	 ...
	 * 
	 * @return The number of lines between highlighted line numbers or zero if
	...
	/*
	 * Component.getPreferredSize() is overridden here to support the collapsing
	 * behavior.
	 */
	@Override
	...
	/*
	 * JComponent.setBorder(Border) is overridden here to cache the left inset
	 * of the border (if any) to avoid having to fetch it during every repaint.
	 */
	@Override
	...
	// {{{ setBorder() method
	/**
	 * Convenience method for setting a default matte border on the right with
	 * the specified border width and color
	 * 
	 * @param width
	...
	// {{{ setExpanded() method
	/**
	 * Sets whether the gutter is collapsed or expanded and force the text area
	 * to update its layout if there is a change.
	 * 
	 * @param expanded
	...
	// {{{ setFont() method
	/*
	 * JComponent.setFont(Font) is overridden here to cache the baseline for the
	 * font. This avoids having to get the font metrics during every repaint.
	 */
	@Override
	...
	/**
	 * Sets the number of lines between highlighted line numbers. Any value less
	 * than or equal to one will result in highlighting being disabled.
	 * 
	 * @param interval
