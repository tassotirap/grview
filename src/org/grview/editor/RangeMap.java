 ...
 * 
 * All lines from fvm[2*n] to fvm[2*n+1]-1 inclusive are visible. All lines from
 * position fvm[2*n+1] to fvm[2*n+2]-1 inclusive are invisible.
 * 
 * Examples: --------- All lines visible: { 0, buffer.getLineCount() } Narrow
 * from a to b: { a, b + 1 } Collapsed fold from a to b: { 0, a + 1, b,
 * buffer.getLineCount() }
 * 
