...
class SelectionManager
{
	 ...
	 * {@link org.grview.actions.Buffer#getLineText(int)}.
	 */
	...
	/**
	 * Returns the x co-ordinates of the selection start and end on the given
	 * line. May return null.
	 */
	...
	/**
	 * Returns if the given point is inside a selection. Used by drag and drop
	 * code in MouseHandler below.
	 */
