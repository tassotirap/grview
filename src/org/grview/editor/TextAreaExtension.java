...
public abstract class TextAreaExtension
{
	 ...
	 *            A graphics context
	 * @param firstLine
	 *            The first screen line
	 * @param lastLine
	 *            The last screen line
	 * @param physicalLines
	 *            The list of physical line numbers. Entries are -1 if the
	 *            screen line is out of range.
	 * @param start
	 *            An array of screen line start offsets.
	 * @param end
	 *            An array of screen line end offsets
	 * @param y
	 *            The y co-ordinate
	 * @param lineHeight
	 *            The line height
	 ...
	 * @param start
	 *            The offset where the screen line begins, from the start of the
	 *            buffer
	 * @param end
	 *            The offset where the screen line ends, from the start of the
	 *            buffer
	 * @param y
	 *            The y co-ordinate of the top of the line's bounding box
	 * @since jEdit 4.0pre4
